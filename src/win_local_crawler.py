...
class Frame(wx.Frame):
    def __init__(self, title, status, account_display=None, 
                 website_display=None, fetcher=None):
    ...
    def layout(self, status):
        ...
        wx.StaticText(parent=self.panel, id=-1, 
                      ...
                      pos=(300, 5), size=(180, 25), style=wx.TE_RICH2)
        self.help_btn = platebtn.PlateButton(parent=self.panel, id_=-1, label='Help?',
                                         pos=(490, 2), size=(50, 25),
    ...
    def on_search(self, event):
        ...
        if query != '':
            ...
            self.uids = search_res.update(res if res is not None else 'Not Find!')
